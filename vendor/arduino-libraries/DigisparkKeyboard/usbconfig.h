 ...
 * the implications!
 */
#define USB_CFG_DEVICE_VERSION VERSION
/* Version number of the device: Minor number first, then major number.
 */
#define USB_CFG_VENDOR_NAME VENDOR_NAME
#define USB_CFG_VENDOR_NAME_LEN VENDOR_NAME_LEN
