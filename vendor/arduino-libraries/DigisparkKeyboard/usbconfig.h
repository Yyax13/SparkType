...
#define USB_CFG_VENDOR_ID USB_VENDOR_ID
 ...
 * the implications!
 */
#define USB_CFG_DEVICE_ID USB_PRODUCT_ID
 ...
 */
#define USB_CFG_VENDOR_NAME 'S', 'p', 'a', 'r', 'k', 'T', 'y', 'p', 'e'
...
#define USB_CFG_DEVICE_NAME                                                    \
  'S', 'p', 'a', 'r', 'k', 'T', 'y', 'p', 'e', ' ', 'K', 'e', 'y', 'S', 't',   \
      'r', 'o', 'k', 'e', ' ', 'I', 'n', 'j', 'e', 'c', 't', 'o', 'r'
